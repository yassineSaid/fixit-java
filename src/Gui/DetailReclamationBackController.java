...
"		<p>Le "+this.reclamation.getDateReclamation()+" </p>\n" +
"	</div>\n" +
"	<div align=\"center\">\n" +
"	<fieldset>\n" +
"		<legend>Rapport de Reclamation</legend>\n" +
"		<div align=\"left\" style=\"font-style: Times New Roman Georgia\">\n" +
"			<p>Mr "+this.reclamation.getUserReclamant().getFirstname()+"</p>\n" +
"			<br>\n" +
"			<br>\n" +
"			<p> Je suis  de la part de l'administration de fixit.</p>\n" +
"			<p> Votre Réclamation d\\'identifiant "+this.reclamation.getId()*45896+" a été prise en considération.</p>\n" +
"			<u><p>Reclamation :</p></u>\n" +
"			<p> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Objet : "+this.reclamation.getObjet()+"</p>\n" +
"			<p>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Description : "+this.reclamation.getDescription()+"</p>\n" +
"			<p>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;La personne que vous avez réclamer :"+this.reclamation.getUserReclame().getFirstname()+" </p>\n" +
"\n" +
"			<p>\n" +
...
"</html>";
    ...
    public void sendMailAvertissement() {
